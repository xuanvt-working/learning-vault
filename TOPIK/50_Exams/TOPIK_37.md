...
**Dịch:**
> Buổi sáng dậy sớm (       ) thì mới bắt kịp chuyến bay lúc bảy giờ.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 일어나야 | [[GR_아어야]] | ✅ | '-아/어야' = "phải… thì mới…"; điều kiện tất yếu: phải dậy sớm mới kịp chuyến bay 7 giờ. |
| ② | 일어나려고 | [[GR_으려고]] | ❌ | '-(으)려고' = "để (dậy sớm)"; chỉ mục đích, không khớp logic "mới có thể". |
| ③ | 일어나며 | [[GR_으며]] | ❌ | '-(으)며' = đồng thời/liệt kê ("vừa… vừa…"); sai nghĩa. |
| ④ | 일어나더니 | [[GR_더니]] | ❌ | '-더니' hồi tưởng quan sát ngôi 3; sai chủ ngữ và mạch câu. |
...
**Dịch:**
> Sau khi tan làm về tới nhà thì thấy em (       ) từ chuyến du lịch.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 돌아와 있었다 | [[GR_아어_있다]] | ✅ | '-아/어 있다' = trạng thái duy trì sau hành động; "đã về và đang ở nhà" — hợp với 와 보니까 (về mới thấy). |
| ② | 돌아오게 되었다 | [[GR_게_되다]] | ❌ | '-게 되다' = "(rốt cuộc) trở nên/thành ra về"; nhấn kết quả do hoàn cảnh, không hợp ngữ cảnh phát hiện trạng thái. |
| ③ | 돌아왔으면 했다 | [[GR_으면_하다]] | ❌ | '-았으면 했다' = "đã mong (em) về"; mong muốn, sai. |
| ④ | 돌아오도록 했다 | [[GR_도록_하다]] | ❌ | '-도록 했다' = "bắt/khiến (ai) về"; sai khiến, sai chủ thể. |
...
- **Ngữ pháp:**
  - N 후에 (sau khi — 퇴근 후에)
  - N에 (đích — 집에)
  - [[GR_아어_보니까]] (-아/어 보니까: "làm rồi mới phát hiện" — 와 보니까)
  - N이/가 (chủ ngữ — 동생이)
  - N에서 (từ — 여행에서)
- **Từ vựng:**
  - 퇴근 — tan làm
  ...
  - 동생 — em
  - 여행 — du lịch
  - 돌아오다 — trở về → [[VC_dong_tu_di_chuyen_가다오다]]
...
**문제:**
> 서둘러 __나온 탓에__ 책상 위에 있는 지갑을 안 가지고 나왔다.

**Dịch:**
> __Vì vội vàng đi ra__ nên đã không cầm theo cái ví để trên bàn.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 나오는 김에 | [[GR_김에]] | ❌ | '-는 김에' = "nhân tiện (ra thì)"; không diễn tả nguyên nhân gây hậu quả xấu. |
| ② | 나오는 사이에 | [[GR_사이에]] | ❌ | '-는 사이에' = "trong lúc (ra)"; chỉ khoảng thời gian, không phải nhân-quả. |
| ③ | 나오는 바람에 | [[GR_바람에]] | ✅ | '-는 바람에' = nguyên nhân đột ngột dẫn tới kết quả (thường tiêu cực) — vội ra nên quên ví; đồng nghĩa 탓에. |
| ④ | 나오는 대신에 | [[GR_대신에]] | ❌ | '-는 대신에' = "thay vì ra"; nghĩa thay thế, sai. |
...
→ __Vì vội vàng đi ra__ nên đã không cầm theo cái ví để trên bàn.
- **Ngữ pháp:**
  - V-아/어 (nối — 서둘러: vội mà…)
  - [[GR_탓에]] (-(으)ㄴ 탓에: "vì… nên (hậu quả xấu)" — phần gạch chân, prompt)
  - N 위에 있는 + N (định ngữ vị trí — 책상 위에 있는 지갑)
  - 안 + V (phủ định — 안 가지고)
- **Từ vựng:**
  - 서두르다 — vội vàng
  - 나오다 — đi ra
...
**문제:**
> 후배가 한 잘못을 알고 있었지만 미안해할까 봐 __모르는 척했다__.

**Dịch:**
> Tuy biết lỗi mà đàn em đã gây ra nhưng vì sợ cậu ấy áy náy nên __đã giả vờ không biết__.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 모르는 체했다 | [[GR_체하다]] | ✅ | '-는 체하다' = "giả vờ (không biết)" — đồng nghĩa hoàn toàn với 척하다. |
| ② | 모르는 듯했다 | [[GR_듯하다]] | ❌ | '-는 듯하다' = "dường như không biết"; phỏng đoán, không phải hành vi giả vờ cố ý. |
| ③ | 모르는 편이다 | [[GR_편이다]] | ❌ | '-는 편이다' = "thuộc dạng không biết"; nêu khuynh hướng, sai. |
| ④ | 모르기 마련이다 | [[GR_기_마련이다]] | ❌ | '-기 마련이다' = "tất nhiên (sẽ) không biết"; quy luật tất yếu, sai. |
...
- **Ngữ pháp:**
  - N이/가 (chủ ngữ — 후배가)
  - V-(으)ㄴ + N (định ngữ quá khứ — 한 잘못)
  - V-고 있다 (đang/trạng thái — 알고 있었다)
  - [[GR_지만]] (nhưng — 있었지만)
  - [[GR_을까_봐]] (-을까 봐: "sợ rằng… nên" — 미안해할까 봐)
  - [[GR_척하다]] (-는 척하다: "giả vờ" — phần gạch chân)
- **Từ vựng:**
  - 후배 — đàn em
  - 잘못 — lỗi lầm
  - 알다 — biết → [[VC_알고있다_vs_알았다]]
  - 미안하다 — áy náy/có lỗi
  - 모르다 — không biết
...
**Dịch:**
> Sạch bong ở mọi lúc mọi nơi!
> Dễ rút ra và lau sạch.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 연필 | bút chì | — | ❌ | Dụng cụ viết, không liên quan lau sạch. |
| ② | 휴지 | giấy (khăn giấy) | [[TOPIC_생활용품]] | ✅ | 깨끗하게 싹싹 · 잘 풀리고 잘 닦임 → cuộn giấy rút ra để lau. |
| ③ | 책상 | bàn học | — | ❌ | Đồ nội thất, không "풀리다". |
| ④ | 거울 | gương | — | ❌ | Để soi, không rút ra/lau. |
...
→ Sạch bong ở mọi lúc mọi nơi!
- **Ngữ pháp:**
  - 언제 어디서나 (bất cứ khi nào/ở đâu — 나 nhấn phổ quát)
  - A-게 → [[GR_게]] (trạng từ hóa — 깨끗하게)
- **Từ vựng:**
  - 언제 — khi nào
  - 어디서나 — bất cứ đâu
  - 깨끗하다 — sạch
  - 싹싹 — (từ tượng thanh) sạch bong
...
- **Ngữ pháp:**
  - 잘 (tốt/dễ — trạng từ)
  - V-고 (và, liệt kê — 풀리고)
  - V-ㅂ니다 (bị/tự động trang trọng — 닦입니다)
- **Từ vựng:**
  - 풀리다 — được rút/gỡ ra (bị động 풀다)
  - 닦이다 — được lau (bị động 닦다)
...
**Dịch:**
> Trân trọng cả món đồ nhỏ!
> Chuyển giao tấm lòng của bạn.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 식당 | nhà hàng | — | ❌ | Phục vụ ăn uống, không giao đồ (배달 물건). |
| ② | 은행 | ngân hàng | — | ❌ | Không liên quan gửi/giao đồ. |
| ③ | 방송국 | đài phát thanh | — | ❌ | Phát sóng, không giao đồ. |
| ④ | 우체국 | bưu điện | [[TOPIC_장소기관]] | ✅ | 물건 · 마음을 배달합니다 → nơi chuyển phát bưu phẩm. |
...
→ Trân trọng cả món đồ nhỏ!
- **Ngữ pháp:**
  - A-(으)ㄴ + N (định ngữ — 작은 물건)
  - N도 (cũng/cả — 물건도)
  - A-게 → [[GR_게]] (trạng từ hóa — 소중하게)
- **Từ vựng:**
  - 작다 — nhỏ
  - 물건 — món đồ
...
- **Ngữ pháp:**
  - N의 (của — 당신의)
  - N을/를 (tân ngữ — 마음을)
  - V-ㅂ니다 (trang trọng — 배달합니다)
- **Từ vựng:**
  - 당신 — bạn/quý vị
  - 마음 — tấm lòng
  - 배달하다 — giao/chuyển phát
...
**Dịch:**
> Dành thời gian và năng lực của bạn cho hàng xóm!
> Tài năng góp lại sẽ thành ước mơ.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 봉사 활동 | hoạt động tình nguyện | [[TOPIC_생활예절]] | ✅ | 시간·능력을 이웃에게 · 재능 모이면 → kêu gọi cống hiến cho cộng đồng. |
| ② | 직업 활동 | hoạt động nghề nghiệp | — | ❌ | Vì thu nhập bản thân, không "이웃에게". |
| ③ | 체육 활동 | hoạt động thể thao | — | ❌ | Không liên quan chia sẻ tài năng. |
| ④ | 경제 활동 | hoạt động kinh tế | — | ❌ | Trọng tâm là tiền, không phải cống hiến. |
...
- **Ngữ pháp:**
  ...
  - N과/와 (và — 시간과 능력)
  - N을/를 (tân ngữ — 능력을)
  - N에게 (cho/tới người — 이웃에게)
- **Từ vựng:**
  - 여러분 — mọi người/các bạn
  - 시간 — thời gian
  - 능력 — năng lực
  - 이웃 — hàng xóm
...
**Dịch:**
> Hãy bảo quản ở nơi thoáng mát.
> Sau khi dùng nhớ đậy kín nắp.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 주의 사항 | điều cần lưu ý | [[TOPIC_주의사항]] | ✅ | 보관하십시오 · 뚜껑을 닫으십시오 → các điều dặn dò khi dùng/bảo quản. |
| ② | 재료 안내 | giới thiệu nguyên liệu | — | ❌ | Không liệt kê thành phần. |
| ③ | 구입 방법 | cách mua | — | ❌ | Không nói việc mua. |
| ④ | 제품 문의 | hỏi về sản phẩm | — | ❌ | Không phải kênh hỏi đáp. |
...
→ Hãy bảo quản ở nơi thoáng mát.
- **Ngữ pháp:**
  - A-(으)ㄴ + N (định ngữ — 시원한 장소)
  - N에 (nơi chốn — 장소에)
  - V-(으)십시오 (mệnh lệnh kính ngữ — 보관하십시오)
- **Từ vựng:**
  - 시원하다 — mát mẻ/thoáng
  - 장소 — nơi/địa điểm
  - 보관하다 — bảo quản
...
- **Ngữ pháp:**
  - N 후 (sau khi — 사용 후)
  - N을/를 (tân ngữ — 뚜껑을)
  - 꼭 (nhất định/kỹ — trạng từ)
  - V-(으)십시오 (mệnh lệnh kính ngữ — 닫으십시오)
- **Từ vựng:**
  - 사용 — sự dùng
  - 뚜껑 — nắp
  - 꼭 — nhất định
...
**문제:**
> 가을밤 별자리축제
> • 일시: 2014년 11월 22일(토) 19:00~23:00
> • 장소: 영월천문대
> • 대상: 초등학생 자녀가 있는 50가족
> • 참가비: 가족당 20,000원 (단, 영월 군민은 무료)
> • 신청 방법: 전화 접수 (☎ 033-123-4567)

**Dịch:**
> Lễ hội chòm sao đêm thu
> • Thời gian: 22/11/2014 (T7) 19:00~23:00
> • Địa điểm: Đài thiên văn Yeongwol
> • Đối tượng: 50 gia đình có con nhỏ tiểu học
> • Phí tham gia: 20.000 won/gia đình (riêng cư dân Yeongwol miễn phí)
> • Cách đăng ký: đăng ký qua điện thoại (☎ 033-123-4567)

**Chủ đề:** 행사전시 (sự kiện / triển lãm) → [[TOPIC_행사전시]]

| # | Phương án | Nghĩa | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|
| ① | 축제는 평일 오후에 개최된다 | Lễ hội tổ chức chiều ngày thường | ❌ | Poster ghi 토요일 저녁 19:00~23:00 → sai cả ngày (thứ 7) lẫn buổi (tối) (candidate 1×). |
| ② | 초등학생들만 축제에 참가할 수 있다 | Chỉ học sinh tiểu học được tham gia | ❌ | Đối tượng là 가족 (có con tiểu học), không phải chỉ học sinh → thu hẹp sai — [[TRAP_chi_gioi_han]]. |
| ③ | 축제에 참가하려면 전화로 신청해야 한다 | Muốn tham gia phải đăng ký qua điện thoại | ✅ | 신청 방법: 전화 접수 → đăng ký qua điện thoại, khớp [[TRAP_phuong_thuc_dang_ky]] (chiều ĐÚNG). |
| ④ | 영월에 사는 사람들은 이만 원을 내야 한다 | Người sống ở Yeongwol phải trả 20.000 won | ❌ | Poster ghi 영월 군민은 무료 (cư dân miễn phí) — [[TRAP_mien_phi_co_phi]]. |
...
→ Đối tượng: 50 gia đình có con nhỏ tiểu học
- **Ngữ pháp:**
  - N이/가 있는 + N (định ngữ "có…" — 자녀가 있는 50가족)
- **Từ vựng:**
  - 대상 — đối tượng
...
→ Phí tham gia: 20.000 won/gia đình (riêng cư dân Yeongwol miễn phí)
- **Ngữ pháp:**
  - N당 (mỗi/tính theo — 가족당)
  - 단 (riêng/tuy nhiên, liên từ)
  - N은/는 (chủ đề — 군민은)
- **Từ vựng:**
  - 참가비 — phí tham gia
  - 단 — riêng/nhưng
...
> 신청 방법: 전화 접수 (☎ 033-123-4567)
→ Cách đăng ký: đăng ký qua điện thoại
- **Ngữ pháp:**
  - N 방법 (cách… — 신청 방법); (các phương án dùng) V-(으)려면 -아/어야 한다 (muốn… thì phải…), N만 (chỉ), -을 수 있다 (có thể)
- **Từ vựng:**
  - 신청 — đăng ký
  - 방법 — cách
  - 전화 — điện thoại
...
**문제 (도표):** 남녀 직장인의 건강 관리법 (%) — đọc xấp xỉ từ biểu đồ cột (không có số in)
...
**Dịch:** Cách quản lý sức khỏe của người đi làm nam/nữ (%) — khám sức khỏe / vận động / giấc ngủ / ăn sáng.

**Chủ đề:** 건강관리 (quản lý sức khỏe) → [[TOPIC_건강관리]]

| # | Phương án | Nghĩa | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|
| ① | 여성은 잠보다 운동을 더 중요하게 여긴다 | Nữ coi trọng vận động hơn giấc ngủ | ❌ | 여 수면(≈38) > 운동(≈12) → đảo chiều so sánh — [[TRAP_dao_so_sanh]]. |
| ② | 남녀 모두 자는 것을 가장 중요하게 생각한다 | Cả nam nữ coi giấc ngủ quan trọng nhất | ✅ | 수면 시간 là mục cao nhất ở cả hai giới → đúng. |
| ③ | 아침을 먹는 사람은 여성보다 남성이 더 많다 | Ăn sáng: nam nhiều hơn nữ | ❌ | 아침 식사 남(≈26) < 여(≈30) → đảo chiều so sánh — [[TRAP_dao_so_sanh]]. |
| ④ | 남성은 밥보다 건강 검진을 더 많이 선택했다 | Nam chọn khám sức khỏe hơn ăn sáng | ❌ | 남 건강검진(≈23) < 아침식사(≈26) → đảo chiều so sánh — [[TRAP_dao_so_sanh]]. |

### Chú giải chi tiết

> 남녀 직장인의 건강 관리법 (%): 건강 검진 · 운동 · 수면 시간 · 아침 식사
→ Cách quản lý sức khỏe của người đi làm nam/nữ (%): khám sức khỏe · vận động · giấc ngủ · ăn sáng
- **Ngữ pháp:**
  - N의 (của — 직장인의)
  - N법 (cách/phương pháp — 관리법); (các phương án dùng) N보다 (so sánh hơn), 가장 (nhất), 모두 (cả), A-게 여기다/생각하다 (coi là… — 중요하게 여기다)
- **Từ vựng:**
  - 직장인 — người đi làm
  - 건강 — sức khỏe
  - 관리 — quản lý
