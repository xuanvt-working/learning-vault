...
**Dịch:**
> Cuối tuần tôi thường xem phim (       ) tập thể dục.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 보지만 | [[GR_지만]] | ❌ | '-지만' = "nhưng"; nêu tương phản, không hợp việc kể hai hoạt động thường làm. |
| ② | 보거나 | [[GR_거나]] | ✅ | '-거나' = "hoặc"; kết hợp 보통 → "thường xem phim hoặc tập thể dục" (làm thay phiên). |
| ③ | 보려고 | [[GR_으려고]] | ❌ | '-(으)려고' = "để xem"; mục đích, sai. |
| ④ | 보더니 | [[GR_더니]] | ❌ | '-더니' hồi tưởng quan sát; sai. |
...
- **Ngữ pháp:**
  - N은/는 (chủ đề — 나는)
  - N에는 (thời điểm nhấn — 주말에는)
  - 보통 (thường, trạng từ tần suất)
  - N을/를 (tân ngữ — 영화를, 운동을)
  - -ㄴ다/는다 (trần thuật văn viết — 한다)
- **Từ vựng:**
  - 나 — tôi
  - 주말 — cuối tuần
  - 보통 — thường
...
| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 닮아 간다 | [[GR_아어_가다]] · [[VC_dong_tu_di_chuyen_가다오다]] | ✅ | '-아/어 가다' = "dần dần… về sau"; khớp 점점 (càng ngày càng): ngày càng giống bố. |
| ② | 닮기도 한다 | [[GR_기도_하다]] | ❌ | '-기도 하다' = "cũng có khi giống"; nêu đôi khi, không hợp "dần dần". |
| ③ | 닮았나 보다 | [[GR_나_보다]] | ❌ | '-았나 보다' = "chắc là (đã) giống"; suy đoán, sai. |
| ④ | 닮은 적이 없다 | [[GR_은_적이_없다]] | ❌ | '-은 적이 없다' = "chưa từng giống"; kinh nghiệm phủ định, sai. |
...
- **Ngữ pháp:**
  - N이/가 (chủ ngữ — 동생이)
  - 점점 (dần dần/càng ngày càng, trạng từ)
  - N을/를 (tân ngữ — 아버지를)
- **Từ vựng:**
  - 동생 — em
  - 점점 — dần dần
...
**문제:**
> 정부는 일자리를 __늘리고자__ 새로운 정책을 수립했다.

**Dịch:**
> Chính phủ đã lập ra chính sách mới __để tăng thêm việc làm__.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 늘리자마자 | [[GR_자마자]] | ❌ | '-자마자' = "vừa tăng là ngay"; tính tức thì, sai. |
| ② | 늘리더라도 | [[GR_더라도]] | ❌ | '-더라도' = "dù có tăng đi nữa"; nhượng bộ, sai. |
| ③ | 늘리는 대신 | [[GR_대신]] | ❌ | '-는 대신' = "thay vì tăng"; thay thế, sai. |
| ④ | 늘리기 위해 | [[GR_기_위해]] | ✅ | '-기 위해' = "để/nhằm tăng"; đồng nghĩa với 고자 (mục đích). |
...
- **Ngữ pháp:**
  - N은/는 (chủ đề — 정부는)
  - N을/를 (tân ngữ — 일자리를, 정책을)
  - [[GR_고자]] (-고자: "để/nhằm…" văn viết trang trọng — phần gạch chân, prompt)
  - A-(으)ㄴ + N (định ngữ — 새로운 정책)
  - -았/었- (quá khứ — 수립했다)
- **Từ vựng:**
  - 정부 — chính phủ
...
**문제:**
> 태어난 지 얼마 안 되어 서울로 왔으니 서울이 __고향인 셈이다__.

**Dịch:**
> Vì sinh ra chưa được bao lâu đã đến Seoul nên Seoul __coi như là quê hương__.

| # | Phương án | Ngữ pháp | Vai | Lý do / Phân tích |
|---|---|---|---|---|
| ① | 고향일 뿐이다 | [[GR_뿐이다]] | ❌ | '-일 뿐이다' = "chỉ là quê mà thôi"; nghĩa giới hạn, sai. |
| ② | 고향이면 좋겠다 | [[GR_으면_좋겠다]] | ❌ | '-이면 좋겠다' = "giá là quê thì tốt"; ước muốn, sai. |
| ③ | 고향일 리가 없다 | [[GR_을_리가_없다]] | ❌ | '-일 리가 없다' = "không thể nào là quê"; phủ định, ngược nghĩa. |
| ④ | 고향이나 마찬가지이다 | [[GR_나_마찬가지이다]] | ✅ | '-(이)나 마찬가지이다' = "chẳng khác nào quê"; đồng nghĩa với 셈이다 (coi như là). |
...
→ Vì sinh ra chưa được bao lâu đã đến Seoul nên Seoul __coi như là quê hương__.
- **Ngữ pháp:**
  - V-(으)ㄴ 지 얼마 안 되다 (mới… chưa được bao lâu — 태어난 지 얼마 안 되어)
  - N(으)로 (hướng đến — 서울로)
  - V-았/었으니 (vì… nên — 왔으니)
  - N이/가 (chủ ngữ — 서울이)
  - [[GR_셈이다]] (-(으)ㄴ 셈이다: "coi như là…" — phần gạch chân, prompt)
- **Từ vựng:**
  - 태어나다 — sinh ra
...
**Dịch:**
> Xua tan cái nóng~
> Tặng bạn làn gió thiên nhiên.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 에어컨 | máy lạnh / điều hòa | [[TOPIC_가전제품]] | ✅ | 더위 · 자연 바람을 선물 → thiết bị làm mát, xua nóng = điều hòa. |
| ② | 청소기 | máy hút bụi | — | ❌ | Hút bụi, không "더위·바람". |
| ③ | 냉장고 | tủ lạnh | — | ❌ | Giữ lạnh thực phẩm, không thổi gió mát cho phòng. |
| ④ | 세탁기 | máy giặt | — | ❌ | Giặt đồ, không liên quan cái nóng. |

### Chú giải chi tiết

> 더위를 싹~ / 자연 바람을 선물합니다.
→ Xua tan cái nóng~ / Tặng bạn làn gió thiên nhiên.
- **Ngữ pháp:**
  - N을/를 (tân ngữ — 더위를, 바람을)
  - 싹 (sạch/hết, tượng thanh)
  - V-ㅂ니다 (trang trọng — 선물합니다)
- **Từ vựng:**
  - 더위 — cái nóng
  - 싹 — sạch bong/hết
  - 자연 — thiên nhiên
...
**Dịch:**
> Tích lũy một cách thông minh!
> Tương lai hạnh phúc mỗi ngày một tích tụ.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 병원 | bệnh viện | — | ❌ | Không liên quan tích lũy tiền. |
| ② | 은행 | ngân hàng | [[TOPIC_장소기관]] | ✅ | 똑똑하게 모으자 · 쌓여 가는 미래 → gửi/tiết kiệm tiền = ngân hàng. |
| ③ | 여행사 | công ty du lịch | — | ❌ | Không nói tích lũy. |
| ④ | 체육관 | nhà thi đấu | — | ❌ | Tập luyện, không liên quan. |

### Chú giải chi tiết

> 똑똑하게 모으자! / 매일매일 쌓여 가는 행복한 미래
→ Tích lũy một cách thông minh! / Tương lai hạnh phúc mỗi ngày một tích tụ.
- **Ngữ pháp:**
  - A-게 → [[GR_게]] (trạng từ hóa — 똑똑하게)
  - V-자 (rủ rê "hãy… nào" — 모으자)
  - [[GR_아어_가다]] (-아/어 가다: "dần dần… về sau" — 쌓여 가는) → [[VC_dong_tu_di_chuyen_가다오다]]
  - A-(으)ㄴ + N (định ngữ — 행복한 미래)
- **Từ vựng:**
  - 똑똑하다 — thông minh
  - 모으다 — gom/tích lũy
  - 매일매일 — mỗi ngày
...
**Dịch:**
> Kỷ niệm để trong tim, rác để trong túi
> Cùng nhau tạo nên ngọn núi khỏe mạnh.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 건강 관리 | quản lý sức khỏe | — | ❌ | 건강한 산 nói về NÚI khỏe mạnh, không phải sức khỏe người. |
| ② | 화재 예방 | phòng cháy | — | ❌ | Không nói lửa/thuốc lá. |
| ③ | 이웃 사랑 | yêu thương hàng xóm | — | ❌ | Không nói về hàng xóm. |
| ④ | 환경 보호 | bảo vệ môi trường | [[TOPIC_환경보호]] | ✅ | 쓰레기는 가방 안에 · 건강한 산 → mang rác về để giữ núi sạch. |
...
→ Kỷ niệm để trong tim, rác để trong túi
- **Ngữ pháp:**
  - N은/는 (đối lập chủ đề — 추억은 … 쓰레기는)
  - N속에 / N 안에 (bên trong — 마음속에, 가방 안에)
- **Từ vựng:**
  - 추억 — kỷ niệm
  - 마음속 — trong lòng/tim
  - 쓰레기 — rác
...
→ Cùng nhau tạo nên ngọn núi khỏe mạnh.
- **Ngữ pháp:**
  - A-(으)ㄴ + N (định ngữ — 건강한 산)
  - 함께 (cùng nhau)
  - V-아/어요 (thân mật lịch sự, cầu khiến — 만들어요)
- **Từ vựng:**
  - 건강하다 — khỏe mạnh
  - 산 — núi
  - 함께 — cùng nhau
...
**문제:**
> 자료실은 평일 오전 9시부터 오후 6시까지 문을 엽니다.
> 책은 1인당 10권, 한 달 동안 빌릴 수 있습니다.

**Dịch:**
> Phòng tư liệu mở cửa các ngày thường từ 9 giờ sáng đến 6 giờ chiều.
> Sách mỗi người mượn được 10 cuốn, trong vòng một tháng.

| # | Phương án | Nghĩa | Chủ đề | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|---|
| ① | 이용 안내 | hướng dẫn sử dụng | [[TOPIC_이용안내]] | ✅ | 운영시간 · 1인 10권 · 한 달 대여 → thông tin CÁCH dùng phòng tư liệu. |
| ② | 구입 문의 | hỏi mua | — | ❌ | Không nói việc mua. |
| ③ | 사용 순서 | trình tự dùng | — | ❌ | Không nêu các bước. |
| ④ | 교환 방법 | cách đổi | — | ❌ | Không nói việc đổi. |
...
**문제:**
> 제3회 한마음 걷기 대회
> ☞ 일시: 2019년 9월 14일(토) 09:00~13:00
> ☞ 참가 대상: 제한 없음
> ☞ 내용: 3.8km 걷기 (시민공원부터 인주기념관까지)
> ☞ 참가비: 무료

**Dịch:**
> Đại hội đi bộ đồng lòng lần thứ 3
> ☞ Thời gian: 14/9/2019 (T7) 09:00~13:00
> ☞ Đối tượng tham gia: không giới hạn
> ☞ Nội dung: đi bộ 3,8km (từ công viên thị dân đến Nhà kỷ niệm Inju)
...
|---|---|---|---|---|
| ① | 이 대회는 이번에 처음으로 열린다 | Đại hội lần này lần đầu tổ chức | ❌ | Poster ghi 제3회 (lần thứ 3) → không phải lần đầu — [[TRAP_lan_dau_vs_thu_N]]. |
| ② | 이 대회에는 누구나 참가할 수 있다 | Ai cũng có thể tham gia | ✅ | 참가 대상: 제한 없음 (không giới hạn) → ai cũng tham gia được, khớp. |
| ③ | 이 대회에 참가하려면 돈을 내야 한다 | Muốn tham gia phải trả tiền | ❌ | Poster ghi 참가비 무료 (miễn phí) — [[TRAP_mien_phi_co_phi]]. |
| ④ | 이 대회의 출발 장소는 인주기념관이다 | Điểm xuất phát là Nhà kỷ niệm Inju | ❌ | Poster ghi 시민공원부터 (xuất phát là công viên; 인주기념관 là đích) → bẫy đảo điểm đầu/cuối (candidate 1×). |

### Chú giải chi tiết

> 참가 대상: 제한 없음 / 내용: 3.8km 걷기 (시민공원부터 인주기념관까지)
→ Đối tượng tham gia: không giới hạn / Nội dung: đi bộ 3,8km (từ công viên thị dân đến Nhà kỷ niệm Inju)
- **Ngữ pháp:**
  - N 없음 (không có… — 제한 없음, danh từ hóa 없다)
  - N부터 N까지 (từ… đến… — 시민공원부터 인주기념관까지)
- **Từ vựng:**
  - 참가 대상 — đối tượng tham gia
  - 제한 — giới hạn
  - 걷기 — việc đi bộ
  - 시민공원 — công viên thị dân
  - 기념관 — nhà kỷ niệm
  - 출발 장소 — nơi xuất phát

> 제3회 한마음 걷기 대회 / 참가비: 무료
→ Đại hội đi bộ đồng lòng lần thứ 3 / Phí tham gia: miễn phí
- **Ngữ pháp:**
  - 제N회 (lần thứ N — 제3회); (các phương án dùng) V-(으)려면 -아/어야 한다 (muốn… phải…)
- **Từ vựng:**
  - 대회 — đại hội
  - 한마음 — đồng lòng/một lòng
  - 참가비 — phí tham gia
  - 무료 — miễn phí
...
**문제 (도표):** 고등학생 희망 직업, 어떻게 달라졌을까? — bảng xếp hạng 2008년 vs 2018년 〈조사 대상: 고등학생 10,000명〉
...
**Dịch:** Nghề mơ ước của học sinh THPT thay đổi thế nào? — thứ hạng năm 2008 so với 2018.

**Chủ đề:** 희망직업 (nghề nghiệp mơ ước) → [[TOPIC_희망직업]]

| # | Phương án | Nghĩa | Vai | Căn cứ / Phân tích |
|---|---|---|---|---|
| ① | 1위 순위의 직업이 바뀌었다 | Nghề hạng 1 đã thay đổi | ❌ | 교사 giữ 1위 cả 2008 lẫn 2018 → hạng 1 không đổi — [[TRAP_thay_doi_thu_hang]]. |
| ② | 공무원은 순위의 변화가 없었다 | Công chức không đổi hạng | ❌ | 공무원 3위(2008)→4위(2018) → có thay đổi — [[TRAP_thay_doi_thu_hang]]. |
| ③ | 군인이 새롭게 5위 안에 들었다 | Quân nhân mới lọt top 5 | ✅ | 2018 하위 5위 군인, 2008 không có trong top5 → mới lọt vào, khớp. |
| ④ | 간호사는 4위로 순위가 떨어졌다 | Y tá rớt xuống hạng 4 | ❌ | 간호사 4위(2008)→2위(2018) → tăng hạng, không rớt — [[TRAP_thay_doi_thu_hang]]. |

### Chú giải chi tiết

> 고등학생 희망 직업, 어떻게 달라졌을까? (2008 vs 2018 순위)
→ Nghề mơ ước của học sinh THPT thay đổi thế nào? (thứ hạng 2008 vs 2018)
- **Ngữ pháp:**
  - 어떻게 (thế nào, nghi vấn)
  - A-아/어지다 (trở nên khác — 달라지다)
  - -았을까? (tự vấn quá khứ — 달라졌을까); (các phương án dùng) N이/가 바뀌다 (thay đổi), 순위에 들다 (lọt vào thứ hạng), 순위가 떨어지다 (rớt hạng)
- **Từ vựng:**
  - 고등학생 — học sinh THPT
  - 희망 직업 — nghề mơ ước
  - 달라지다 — thay đổi
